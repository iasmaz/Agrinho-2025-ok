...
// Caminhos corrigidos — use direto na raiz ou garanta que exista a pasta 'imagens'
...
btnIniciar.addEventListener("click", () => {
  ...
  // 🔊 Tenta tocar a música com segurança
  musica.play().catch((e) => {
    console.warn("⚠️ Som bloqueado pelo navegador até nova interação.", e);
  });
